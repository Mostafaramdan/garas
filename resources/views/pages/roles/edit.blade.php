            ...
            <div class="card-body">
                <form method="POST" action="{{route('roles.update',$role->id)}}">
                    ...
                    <div class="form-group mb-5">
                        ...
                        <input type="text" name="name"  value="{{$role->name}} " class="form-control form-control-solid">
                        @error('name')
                                        ...
                                        @foreach(permissionInfo($module) as $action)
                                            <li class="list-group-item list-group-item-action ">
                                                <div class="n-chk">
                                                    ...
                                                    <input type="checkbox" class="new-control-input" @checked(str_contains($role->permissions,$action['input']) ) name="{{$action['input']}}">
