...
class ShowSpecificClassRoomsTables implements classRoomInterface
{
    public $render;
    private $id,$request;
    ...
    public function handle () :void
    {
        ...
        $this->render=  view('pages.school_timetables.show', compact('records'),['id'=>$this->id,'name'=>school_timetables::find($this->id)->name]) ;
