...
class swapClassRooms implements classRoomInterface
{
    ...
    public function handle () :void
    {
        ...
        $this->render=  view('pages.school_timetables.swapClassRooms', compact('records'),[
            'id'=>$this->id,
            'class'=>classes::find($this->request->classes_id),
            'school_timetable'=>school_timetables::find($this->id),
            'records_json'=>json_encode($records,true)
        ]) ;
